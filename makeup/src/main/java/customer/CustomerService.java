...
public interface CustomerService {
	...
	CustomerVO findId_email(String customer_name, String customer_email);	// 아이디 찾기 - email
	CustomerVO findId_phone(String customer_name, String customer_phone);	// 아이디 찾기 - phone
	
	CustomerVO findPw(String customer_id, String customer_name, String customer_phone, String customer_email);	// 비밀번호 찾기
}
